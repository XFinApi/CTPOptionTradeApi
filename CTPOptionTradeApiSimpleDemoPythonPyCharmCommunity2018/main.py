######################################################
# CTPOptionTradeApiSimpleDemoPythonPyCharmCommunity2018
# www.xfinapi.com
######################################################
...
class MarketTest:
    ...
    def test(self):
        self.market = XFinApi_TradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/CTPOption_v1.0_20160628/XFinApi.CTPOptionTradeApi.dll")
...
class TradeTest:
    ...
    def Test(self):
        ...
        self.trade = XFinApi_TradeApi.XFinApi_CreateTradeApi(
            "XTA_W32/Api/CTPOption_v1.0_20160628/XFinApi.CTPOptionTradeApi.dll")
