/*******************************************************
* CTPOptionTradeApiSimpleDemoVC2015_X64
* www.xfinapi.com
*******************************************************/
...
2.拷贝XTA_W64\Api\CTPOption_vX.X.X_XXXXXXXX目录（X.X.X_XXXXXXXX为版本号）下的所有dll文件到可执行文件目录，
...
void MarketTest()
{
	...
	int err = -1;
#ifdef _DEBUG
	market = XFinApi_CreateMarketApi("XTA_W64/Api/CTPOption_v1.0_20160628/XFinApi.CTPOptionTradeApid.dll", &err);
#else
	market = XFinApi_CreateMarketApi("XTA_W64/Api/CTPOption_v1.0_20160628/XFinApi.CTPOptionTradeApi.dll", &err);
#endif
