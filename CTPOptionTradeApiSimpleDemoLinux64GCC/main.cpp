/*******************************************************
* CTPOptionTradeApiSimpleDemoLinux64GCC
* www.xfinapi.com
*******************************************************/
...
void MarketTest()
{
	...
	market = XFinApi_CreateMarketApi("XTA_L64/Api/CTPOption_v1.0_20160628/XFinApi.CTPOptionTradeApi.so", &err);
...
void TradeTest()
{
	...
	trade = XFinApi_CreateTradeApi("XTA_L64/Api/CTPOption_v1.0_20160628/XFinApi.CTPOptionTradeApi.so", &err);
