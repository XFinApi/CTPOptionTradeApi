/*******************************************************
* CTPOptionTradeApiSimpleDemoCSharpCore2017_X64
* www.xfinapi.com
*******************************************************/
using System;
...
namespace CTPOptionTradeApiSimpleDemoCSharpCore2017_X64
{
    class Program
    {
        //////////////////////////////////////////////////////////////////////////////////
        ...
        class Config
        {
            ...
            //合约
            public string InstrumentID = "au1906";
        ...
        static void MarketTest()
        {
            ...
            market = ITradeApi.XFinApi_CreateMarketApi("XTA_W64/Api/CTPOption_v1.0_20160628/XFinApi.CTPOptionTradeApi.dll", out err);
        ...
        static void TradeTest()
        {
            ...
            trade = ITradeApi.XFinApi_CreateTradeApi("XTA_W64/Api/CTPOption_v1.0_20160628/XFinApi.CTPOptionTradeApi.dll", out err);
